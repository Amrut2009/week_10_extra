...
public class Programme_10_TubeLine_Advanced {
    public static void main(String[] args) {
        ...
        String station [] = (" Aldgate , Angle , baker street , Bank, Barbican, Bayswater, Blackfriars,bond street,"+"Bourough, canon street , chancery lane , charing cross, covent garden, earl's court ,"+
                "Edgware road, elephant & castle , embankment,euston square ,"+ "Ferringdon,glouester road , googs street ,great porland street , green park").split(",");
